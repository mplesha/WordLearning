...
(function() {
  ...
  this.VKI_kts = this.VKI_kt = "UK Transcription";  // Default keyboard layout
  this.VKI_langAdapt = true;  // Use lang attribute of input to select keyboard
  this.VKI_size = 2;  // Default keyboard size (1-5)
  this.VKI_sizeAdj = true;  // Allow user to adjust keyboard size
  this.VKI_clearPasswords = false;  // Clear password fields on focus
  this.VKI_imageURI = "/Content/images/keyboard.png";  // If empty string, use imageless mode
  ...
  this.VKI_layout['United Kingdom'] = {
   ...
   this.VKI_layout['UK Transcription'] = {
       'name': "UK Transcription", 'keys': [
         [["`", "~"], ["1", "!"], ["2", "@"], ["3", "#"], ["4", "$"], ["5", "%"], ["6", "^"], ["7", "&"], ["8", "*"], ["9", "("], ["0", ")"], ["-", "_"], ["=", "+"], ["Bksp", "Bksp"]],
         [["Tab", "Tab"], ["ɪ", "p"], ["æ", "b"], ["ɒ", "t"], ["ʌ", "d"], ["ʊ", "k"], ["g"], ["tʃ", "e"], ["dʒ"], ["iː", "f"], ["eɪ", "v"], ["[", "{"], ["]", "}"], ["\\", "|"]],
         [["Caps", "Caps"], ["θ"], ["ð"], ["aɪ", "s"], ["ɔɪ", "z"], ["ʃ"], ["ʒ"], ["uː", "h"], ["ə", "m"], ["ɔ", "n"], [":", ";"], ["'", '"'], ["Enter", "Enter"]],
         [["Shift", "Shift"], ["ŋ"], ["l"], ["ɔː", "r"], ["ɜ", "j"], ["eə", "w"], ["ʔ"], ["ŋ"], [",", "<"], [".", ">"], ["/", "?"], ["Shift", "Shift"]],
         [[" ", " ", " ", " "]]
       ], 'lang': ["en"]
   };
